  ...
  const categorias = {
    hamburgers: [
      ...
      },
      {
        ...
        calorias: 980,
        description:
          'A bacon burger is a hamburger topped with crispy bacon, often combined with cheese for extra flavor.',
      },
      {
        id: 3,
        nome: 'Veggie Burger',
        ...
        calorias: 420,
        description:
          'A veggie burger is made from plant-based ingredients such as beans, grains, or vegetables, served like a traditional burger.',
      },
      {
        id: 4,
        nome: 'Double Burger',
        ...
        calorias: 1200,
        description:
          'A double burger comes with two meat patties stacked together, usually with cheese and other toppings.',
      },
    ],
    pizzas: [
      {
        ...
        calorias: 890,
        description:
          'A classic Margherita pizza with fresh tomato sauce, mozzarella cheese, and basil leaves.',
      },
      {
        id: 6,
        nome: 'Pepperoni',
      ...
      },
      {
        ...
        calorias: 1100,
        description:
          'A four-cheese pizza combining mozzarella, gorgonzola, parmesan, and provolone.',
      },
      {
        id: 8,
        nome: 'Frango',
